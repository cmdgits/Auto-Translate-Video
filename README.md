...
- Xuất video thuyết minh để tạo file `.mp4` có giọng đọc tiếng Việt dựa trên phụ đề đã dịch hoặc đã sửa; mặc định tắt tiếng video gốc.
...
Khi xuất video thuyết minh, hệ thống sẽ dùng nội dung phụ đề tiếng Việt hiện tại. Nếu bạn đã sửa phụ đề trên web, hãy lưu phụ đề trước khi render để video thuyết minh dùng đúng nội dung mới nhất. Mặc định `background_audio_gain: 0.0` để tắt hoàn toàn tiếng video gốc, chỉ giữ giọng đọc thuyết minh.
