...
def _options_from_form(
    ...
    return PipelineRunOptions(
        ...
        subtitle_font_family=subtitle_font_family or None,
        subtitle_font_weight=subtitle_font_weight or None,
        subtitle_primary_color=subtitle_primary_color or None,
...
async def create_job(
    ...
    subtitle_font_family: str | None = Form(None),
    subtitle_font_weight: str | None = Form(None),
    subtitle_primary_color: str | None = Form(None),
